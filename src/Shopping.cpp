    ...
    else
    {
        ...
        switch(ch)
        {
            case 1:
                    ...
                    break;
            case 2:
                    cout<<"Enter item to Edit quantity"<<endl;
                    cin>>n;
                    for(int i=0;i<totalitems;i++)
                    {
                        if(n==a[i].name)
                        {
                            ...
                            cout<<"Enter how much quantity u want:"<<endl;
                            cin>>k;
                            a[i].quantity=k;
                            totalamount+=((a[i].price)*(a[i].quantity));
...
void Shopping :: setcartempty()
{
        totalitems=0;
        totalamount=0;
        cout<<"Cart is empty now"<<endl;
}
float Shopping :: gettotalAmount()
{
    return totalamount;
}